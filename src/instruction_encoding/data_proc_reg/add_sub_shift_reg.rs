...
#[inline(always)]
fn emit_add_sub<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    sf: u8,
    op: u8,
    s: u8,
...
#[inline(always)]
fn emit_add_sub_shift<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    sf: u8,
    op: u8,
    s: u8,
