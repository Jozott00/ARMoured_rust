...
#[inline(always)]
fn emit_ld_st_noallo<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
...
#[inline(always)]
fn emit_ld_st_noallo_32<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
...
#[inline(always)]
fn emit_ld_st_noallo_64<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
...
#[inline(always)]
fn emit_ld_st_noallo_128<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
