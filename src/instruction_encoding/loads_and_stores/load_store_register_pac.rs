...
use crate::types::{Imm10, Imm9, Register};

#[inline(always)]
fn emit_ld_st_reg_pac<P: InstructionProcessor<T>, T>(proc: &mut P, size: u8, v: u8, m: u8, s: u8, imm9: u16, w: u8, rn: Register, rt: Register) -> T {
...
#[inline(always)]
fn emit_ld_st_reg_pac_checked<P: InstructionProcessor<T>, T>(proc: &mut P, size: u8, v: u8, m: u8, simm: Imm10, w: u8, rn: Register, rt: Register) -> T {
