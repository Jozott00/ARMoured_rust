...
#[inline(always)]
fn emit_ld_st_reg_offset<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
...
#[inline(always)]
fn emit_ld_st_reg_offset_32<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
...
#[inline(always)]
fn emit_ld_st_reg_offset_64<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
...
#[inline(always)]
fn emit_ld_st_reg_offset_128<P: InstructionProcessor<T>, T>(
    proc: &mut P,
    opc: u8,
    v: u8,
    l: u8,
